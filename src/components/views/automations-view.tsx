      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">
            {automations.length} {t.automations.title.toLowerCase()} ·{" "}
            {enabledCount} {t.automations.active.toLowerCase()}
          </p>
        </div>
        <Button
          size="sm"
        ...
        {statCards.map((stat, i) => {
          ...
          return (
            <motion.div key={i} variants={item}>
              <Card
                className={`relative overflow-hidden border ${stat.borderAccent} shadow-sm hover:shadow-md transition-shadow duration-300 group`}
              >
                <div
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-4 mt-3">
                          <span className="text-[11px] text-muted-foreground flex items-center gap-1 font-medium">
                            ...
                            {t.automations.ran} {automation.runCount}{" "}
                            {t.automations.times}
                          </span>
                          {automation.lastRun && (
                            <span className="text-[11px] text-muted-foreground flex items-center gap-1 font-medium">
