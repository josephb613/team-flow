    ...
    <div className="min-h-screen flex relative overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-[oklch(0.17_0.02_155)] via-[oklch(0.20_0.04_155)] to-[oklch(0.15_0.06_160)] items-center justify-center p-12">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            className="absolute bottom-1/4 right-10 w-96 h-96 rounded-full bg-[oklch(0.55_0.15_160/0.07)] blur-3xl animate-pulse"
            style={{ animationDelay: "1s" }}
          />
          <div
            className="absolute top-1/2 left-1/3 w-48 h-48 rounded-full bg-[oklch(0.65_0.15_80/0.08)] blur-3xl animate-pulse"
        ...
        <div className="relative z-10 max-w-lg w-full">
          ...
          >
            ...
            <h1 className="text-4xl font-bold text-white mb-4 leading-tight">
              {t.login.leftTitle1}
              <br />
              <span className="text-[oklch(0.65_0.16_160)]">
                {t.login.leftTitle2}
              </span>
            </h1>
              ...
              {stats.map((stat, i) => (
                <div key={i} className="flex items-center gap-1.5">
                  <span className="text-2xl font-bold">
                    <AnimatedCounter
                      target={stat.value === 99.9 ? 99 : stat.value}
                      suffix={stat.value === 99.9 ? "" : stat.suffix}
                    />
        ...
        >
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-bold mb-2">
              {mode === "login" ? t.login.welcomeBack : "Créer un compte"}
            </h2>
            <p className="text-muted-foreground">
              {mode === "login"
                ? t.login.subtitle
                : "Rejoignez TeamFlow dès aujourd'hui"}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  className="text-xs text-[oklch(0.55_0.15_160)] hover:text-[oklch(0.45_0.15_160)] font-medium"
                >
            ...
            {mode === "login" ? (
              <>
                ...
                <button
                  ...
                  className="text-[oklch(0.55_0.15_160)] hover:text-[oklch(0.45_0.15_160)] font-medium"
                >
                  {t.login.createOne}
                </button>
              </>
