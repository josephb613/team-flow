        ...
        {isQueryEmpty ? (
          <>
              ...
              <CommandGroup heading={t.search.recent}>
                {recentPages.map((page) => (
                  <CommandItem
                    ...
                    onSelect={() =>
                      runCommand(() => handlePageSelect(page.pageId as PageId))
                    }
            ...
            <CommandGroup heading={t.search.quickActions}>
              <CommandItem
                onSelect={() => runCommand(() => setCreateTaskDialogOpen(true))}
              >
              ...
              <CommandItem
                onSelect={() =>
                  runCommand(() => setCreateProjectDialogOpen(true))
                }
              >
            ...
            <CommandGroup heading={t.search.pages}>
              {pages.map((page) => (
                <CommandItem
                  key={page.pageId}
                  onSelect={() =>
                    runCommand(() => handlePageSelect(page.pageId))
                  }
                >
                  {page.icon}
                ...
                {filteredTasks.map((task) => {
                  ...
                  return (
                    <CommandItem
                      ...
                      className="flex items-center gap-2"
                    >
                      <span className={statusColorMap[task.status]}>
